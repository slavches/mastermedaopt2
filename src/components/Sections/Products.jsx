...
const productsData = [
  {
    ...
    description: "Натуральный цветочный мёд с добавлением имбиря. Отличается мягким медовым вкусом с лёгкими пряными нотками и характерным ароматом имбиря. Такой мёд хорошо сочетается с чаем, домашними напитками, выпечкой и десертами. Благодаря удачному сочетанию натурального мёда и имбиря продукт обладает ярким вкусом и пользуется популярностью среди любителей необычных медовых композиций. Подходит как для ежедневного употребления, так и в качестве оригинального подарка."
  },
  {
    id: 2,
    filterCategory: "gift",
  ...
  },
  {
    ...
    description: "Натуральный цветочный мёд, собранный с различных луговых и полевых медоносов. Отличается мягким сбалансированным вкусом, приятным ароматом цветущих трав и красивым золотистым оттенком. Разнотравный мёд считается одним из самых универсальных сортов и подходит для ежедневного употребления. Его используют с чаем, кашами, творогом, выпечкой и другими блюдами. Благодаря разнообразию медоносных растений каждая партия может иметь свои уникальные вкусовые особенности."
  },
  {
    id: 5,
    filterCategory: "classic",
  ...
  },
  {
    ...
    weight: "240 гр.",
    images: [
      "/images/limon240/limon2401.webp",  
      "/images/limon240/limon2402.webp",
      "/images/limon240/limon2403.webp",
      "/images/limon240/limon2404.webp",
      "/images/limon240/limon2405.webp" 
    ],
    description: "Натуральный цветочный мёд с добавлением лимона. Отличается мягким медовым вкусом с лёгкими пряными нотками и характерным ароматом лимона. Такой мёд хорошо сочетается с чаем, домашними напитками, выпечкой и десертами. Благодаря удачному сочетанию натурального мёда и лимона продукт обладает ярким вкусом и пользуется популярностью среди любителей необычных медовых композиций. Подходит как для ежедневного употребления, так и в качестве оригинального подарка."
  },
  {
    id: 17,
    filterCategory: "Докторъ Мёд",
    ...
    weight: "330 гр.",
    images: [
      "/images/lesnoi330/lesnoi3301.webp",
      "/images/lesnoi330/lesnoi3302.webp"
    ],
    description: "Натуральный цветочный мёд, собранный с различных лесных медоносов. Отличается мягким сбалансированным вкусом, приятным ароматом лесных трав и красивым золотистым оттенком. Лесной мёд считается одним из самых уникальных сортов и подходит для ежедневного употребления. Его используют с чаем, кашами, творогом, выпечкой и другими блюдами. Благодаря разнообразию медоносных растений каждая партия может иметь свои уникальные вкусовые особенности."
  },
  {
    id: 18,
    filterCategory: "Докторъ Мёд",
    ...
    weight: "330 гр.",
    images: [
      "/images/lygovoi330/lygovoi3301.webp",
      "/images/lygovoi330/lygovoi3302.webp"
    ],
    description: "Натуральный цветочный мёд, собранный с различных луговых медоносов. Отличается мягким сбалансированным вкусом, приятным ароматом луговых трав и красивым золотистым оттенком. Луговой мёд считается одним из самых универсальных сортов и подходит для ежедневного употребления. Его используют с чаем, кашами, творогом, выпечкой и другими блюдами. Благодаря разнообразию медоносных растений каждая партия может иметь свои уникальные вкусовые особенности."
  },
  {
    id: 19,
    filterCategory: "bulk",
  ...
  },
  {
    ...
    weight: "900 гр.",
    images: [
      "/images/cvetochnii900/cvetochnii900.webp"
    ],
